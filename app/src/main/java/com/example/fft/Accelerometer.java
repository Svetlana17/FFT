...
public class Accelerometer {
    ...
    private SensorEventListener augSensorEventListener;
    ...
    public Accelerometer(MainActivity mainActivity) throws Exception {
        this.mainActivity = mainActivity;
        this.sensorManager = (SensorManager) mainActivity.getSystemService(MainActivity.SENSOR_SERVICE);
        this.accelerometer = sensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
        this.augSensorEventListener = new SensorEventListener() {
            @Override
    ...
    public void register() {
        sensorManager.registerListener((SensorEventListener) augSensorEventListener, accelerometer, SENSOR_DELAY);
